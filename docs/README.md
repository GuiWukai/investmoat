# InvestMoat documentation

| Doc | Contents |
|---|---|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Tech stack, directory layout, routes, rendering model, live-price data flow |
| [SCORING.md](./SCORING.md) | Moat / growth / valuation / composite formulas, recommendation bands, portfolio selection |
| [DATA-MODEL.md](./DATA-MODEL.md) | Stock JSON schema, the two-registry system, validation, adding & updating stocks |
