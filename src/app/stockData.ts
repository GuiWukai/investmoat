...
const allCoverageData = [
    ...
    { name: "Booking Holdings", ticker: "BKNG", slug: "bkng",        scores: [80, 74, 75], href: "/stocks/bkng",        category: "Other",       bearTarget: "$2,800",    baseTarget: "$5,000",    bullTarget: "$7,000"    },
    ...
    { name: "Walt Disney",       ticker: "DIS",  slug: "dis",         scores: [76, 69, 74], href: "/stocks/dis",         category: "Other",       bearTarget: "$70",       baseTarget: "$120",      bullTarget: "$165"      },
