...
export const stockData = [
    ...
    { name: "Meta",       ticker: "META", scores: [68, 85, 65], href: "/stocks/meta",       category: "Big Tech"    },
    ...
    { name: "K92 Mining", ticker: "KNT",  scores: [42, 90, 60], href: "/stocks/k92",        category: "Hard Assets" },
];
