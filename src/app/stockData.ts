...
// Keys: Platforms, Software, Semiconductors, Financials, Healthcare, Industrials, Energy, Consumer, Hard Assets, Crypto, Other.
const allCoverageData = [
    ...
    { name: "MercadoLibre",      ticker: "MELI",  slug: "meli",        scores: [m(meliData),        g(meliData),        v(meliData)],        href: "/stocks/meli",        category: "Platforms",       ...t(meliData)        },
    { name: "Ferrari",           ticker: "RACE",  slug: "race",        scores: [m(raceData),        g(raceData),        v(raceData)],        href: "/stocks/race",        category: "Consumer",       ...t(raceData)        },
    { name: "Constellation Energy", ticker: "CEG", slug: "ceg",       scores: [m(cegData),         g(cegData),         v(cegData)],         href: "/stocks/ceg",         category: "Energy",       ...t(cegData)         },
    { name: "Vistra Corp.",         ticker: "VST", slug: "vst",        scores: [m(vstData),         g(vstData),         v(vstData)],         href: "/stocks/vst",         category: "Energy",       ...t(vstData)         },
    ...
    { name: "Microsoft",         ticker: "MSFT",  slug: "msft",        scores: [m(msftData),        g(msftData),        v(msftData)],        href: "/stocks/msft",        category: "Software",    ...t(msftData)        },
    ...
    { name: "ASML",              ticker: "ASML",  slug: "asml",        scores: [m(asmlData),        g(asmlData),        v(asmlData)],        href: "/stocks/asml",        category: "Semiconductors",    ...t(asmlData)        },
    { name: "NVIDIA",            ticker: "NVDA",  slug: "nvda",        scores: [m(nvdaData),        g(nvdaData),        v(nvdaData)],        href: "/stocks/nvda",        category: "Semiconductors",    ...t(nvdaData)        },
    { name: "Amazon",            ticker: "AMZN",  slug: "amazon",      scores: [m(amazonData),      g(amazonData),      v(amazonData)],      href: "/stocks/amazon",      category: "Platforms",    ...t(amazonData)      },
    ...
    { name: "Google",            ticker: "GOOGL", slug: "google",      scores: [m(googleData),      g(googleData),      v(googleData)],      href: "/stocks/google",      category: "Platforms",    ...t(googleData)      }, // Bear $235 / Base $420 / Bull $560
    { name: "TSMC",              ticker: "TSM",   slug: "tsm",         scores: [m(tsmData),         g(tsmData),         v(tsmData)],         href: "/stocks/tsm",         category: "Semiconductors",    ...t(tsmData)         },
    { name: "Intuit",            ticker: "INTU",  slug: "intuit",      scores: [m(intuitData),      g(intuitData),      v(intuitData)],      href: "/stocks/intuit",      category: "Software",  ...t(intuitData)      },
    { name: "Shopify",           ticker: "SHOP",  slug: "shop",        scores: [m(shopData),        g(shopData),        v(shopData)],        href: "/stocks/shop",        category: "Platforms",    ...t(shopData)        },
    { name: "Bitcoin",           ticker: "BTC",   slug: "btc",         scores: [m(btcData),         g(btcData),         v(btcData)],         href: "/stocks/btc",         category: "Crypto", ...t(btcData)         },
    { name: "Ethereum",          ticker: "ETH",   slug: "ethereum",    scores: [m(ethereumData),    g(ethereumData),    v(ethereumData)],    href: "/stocks/ethereum",    category: "Crypto", ...t(ethereumData)    },
    { name: "Solana",            ticker: "SOL",   slug: "solana",      scores: [m(solanaData),      g(solanaData),      v(solanaData)],      href: "/stocks/solana",      category: "Crypto", ...t(solanaData)      },
    { name: "Palantir",          ticker: "PLTR",  slug: "pltr",        scores: [m(pltrData),        g(pltrData),        v(pltrData)],        href: "/stocks/pltr",        category: "Software",    ...t(pltrData)        },
    { name: "Salesforce",        ticker: "CRM",   slug: "crm",         scores: [m(crmData),         g(crmData),         v(crmData)],         href: "/stocks/crm",         category: "Software",  ...t(crmData)         },
    { name: "Broadcom",          ticker: "AVGO",  slug: "avgo",        scores: [m(avgoData),        g(avgoData),        v(avgoData)],        href: "/stocks/avgo",        category: "Semiconductors",    ...t(avgoData)        },
    { name: "CrowdStrike",       ticker: "CRWD",  slug: "crowdstrike", scores: [m(crowdstrikeData), g(crowdstrikeData), v(crowdstrikeData)], href: "/stocks/crowdstrike", category: "Software",    ...t(crowdstrikeData) },
    { name: "Meta",              ticker: "META",  slug: "meta",        scores: [m(metaData),        g(metaData),        v(metaData)],        href: "/stocks/meta",        category: "Platforms",    ...t(metaData)        },
    { name: "Apple",             ticker: "AAPL",  slug: "aapl",        scores: [m(aaplData),        g(aaplData),        v(aaplData)],        href: "/stocks/aapl",        category: "Platforms",    ...t(aaplData)        },
    { name: "Tesla",             ticker: "TSLA",  slug: "tesla",       scores: [m(teslaData),       g(teslaData),       v(teslaData)],       href: "/stocks/tesla",       category: "Industrials",    ...t(teslaData)       },
    { name: "Micron",            ticker: "MU",    slug: "micron",      scores: [m(micronData),      g(micronData),      v(micronData)],      href: "/stocks/micron",      category: "Semiconductors",    ...t(micronData)      },
    ...
    { name: "Netflix",           ticker: "NFLX",  slug: "nflx",        scores: [m(nflxData),        g(nflxData),        v(nflxData)],        href: "/stocks/nflx",        category: "Platforms",    ...t(nflxData)        },
    { name: "Figma",             ticker: "FIG",   slug: "fig",         scores: [m(figData),         g(figData),         v(figData)],         href: "/stocks/fig",         category: "Software",    ...t(figData)         },
    { name: "Adobe",             ticker: "ADBE",  slug: "adbe",        scores: [m(adbeData),        g(adbeData),        v(adbeData)],        href: "/stocks/adbe",        category: "Software",  ...t(adbeData)        },
    { name: "AMD",               ticker: "AMD",   slug: "amd",         scores: [m(amdData),         g(amdData),         v(amdData)],         href: "/stocks/amd",         category: "Semiconductors",    ...t(amdData)         },
    ...
    { name: "Costco",            ticker: "COST",  slug: "costco",      scores: [m(costcoData),      g(costcoData),      v(costcoData)],      href: "/stocks/costco",      category: "Consumer",  ...t(costcoData)      },
    { name: "Walt Disney",       ticker: "DIS",   slug: "disney",      scores: [m(disneyData),      g(disneyData),      v(disneyData)],      href: "/stocks/disney",      category: "Platforms",       ...t(disneyData)      },
    { name: "ServiceNow",        ticker: "NOW",   slug: "now",         scores: [m(nowData),         g(nowData),         v(nowData)],         href: "/stocks/now",         category: "Software",    ...t(nowData)         },
    { name: "Oracle",            ticker: "ORCL",  slug: "orcl",        scores: [m(orclData),        g(orclData),        v(orclData)],        href: "/stocks/orcl",        category: "Software",    ...t(orclData)        },
    ...
    { name: "NextEra Energy",    ticker: "NEE",   slug: "nee",         scores: [m(neeData),         g(neeData),         v(neeData)],         href: "/stocks/nee",         category: "Energy",       ...t(neeData)         },
    ...
    { name: "Strategy Inc.",     ticker: "MSTR",  slug: "mstr",        scores: [m(mstrData),        g(mstrData),        v(mstrData)],        href: "/stocks/mstr",        category: "Crypto", ...t(mstrData)        },
    { name: "Cloudflare",        ticker: "NET",   slug: "net",         scores: [m(netData),         g(netData),         v(netData)],         href: "/stocks/net",         category: "Software",    ...t(netData)         },
    ...
    { name: "AppLovin",          ticker: "APP",   slug: "applovin",    scores: [m(appData),         g(appData),         v(appData)],         href: "/stocks/applovin",    category: "Platforms",    ...t(appData)         },
    { name: "Arista Networks",   ticker: "ANET",  slug: "anet",        scores: [m(anetData),        g(anetData),        v(anetData)],        href: "/stocks/anet",        category: "Semiconductors",    ...t(anetData)        },
    ...
    { name: "The Trade Desk",    ticker: "TTD",   slug: "ttd",         scores: [m(ttdData),         g(ttdData),         v(ttdData)],         href: "/stocks/ttd",         category: "Platforms",    ...t(ttdData)         },
    { name: "Palo Alto Networks",ticker: "PANW",  slug: "panw",        scores: [m(panwData),        g(panwData),        v(panwData)],        href: "/stocks/panw",        category: "Software",    ...t(panwData)        },
    { name: "Arm Holdings",      ticker: "ARM",   slug: "arm",         scores: [m(armData),         g(armData),         v(armData)],         href: "/stocks/arm",         category: "Semiconductors",    ...t(armData)         },
    ...
    { name: "Reddit",            ticker: "RDDT",  slug: "rddt",        scores: [m(rddtData),        g(rddtData),        v(rddtData)],        href: "/stocks/rddt",        category: "Platforms",    ...t(rddtData)        },
    { name: "Sea Limited",       ticker: "SE",    slug: "sea",         scores: [m(seaData),         g(seaData),         v(seaData)],         href: "/stocks/sea",         category: "Platforms",       ...t(seaData)         },
    { name: "Okta",              ticker: "OKTA",  slug: "okta",        scores: [m(oktaData),        g(oktaData),        v(oktaData)],        href: "/stocks/okta",        category: "Software",    ...t(oktaData)        },
    { name: "Duolingo",          ticker: "DUOL",  slug: "duolingo",    scores: [m(duolingoData),    g(duolingoData),    v(duolingoData)],    href: "/stocks/duolingo",    category: "Platforms",       ...t(duolingoData)    },
    ...
    { name: "KLA Corporation",   ticker: "KLAC",  slug: "klac",        scores: [m(klacData),        g(klacData),        v(klacData)],        href: "/stocks/klac",        category: "Semiconductors",    ...t(klacData)        },
    { name: "Cheniere Energy",   ticker: "LNG",   slug: "lng",         scores: [m(lngData),         g(lngData),         v(lngData)],         href: "/stocks/lng",         category: "Energy",       ...t(lngData)         },
    { name: "Super Micro Computer", ticker: "SMCI", slug: "smci",      scores: [m(smciData),        g(smciData),        v(smciData)],        href: "/stocks/smci",        category: "Semiconductors",    ...t(smciData)        },
    ...
    { name: "Dell Technologies", ticker: "DELL",  slug: "dell",        scores: [m(dellData),        g(dellData),        v(dellData)],        href: "/stocks/dell",        category: "Semiconductors",    ...t(dellData)        },
    { name: "Credo Technology",  ticker: "CRDO",  slug: "crdo",        scores: [m(crdoData),        g(crdoData),        v(crdoData)],        href: "/stocks/crdo",        category: "Semiconductors",    ...t(crdoData)        },
    ...
    { name: "Spotify",           ticker: "SPOT",  slug: "spot",        scores: [m(spotData),        g(spotData),        v(spotData)],        href: "/stocks/spot",        category: "Platforms",    ...t(spotData)        },
    { name: "Uber Technologies", ticker: "UBER",  slug: "uber",        scores: [m(uberData),        g(uberData),        v(uberData)],        href: "/stocks/uber",        category: "Platforms",    ...t(uberData)        },
    { name: "Airbnb",            ticker: "ABNB",  slug: "abnb",        scores: [m(abnbData),        g(abnbData),        v(abnbData)],        href: "/stocks/abnb",        category: "Platforms",    ...t(abnbData)        },
    { name: "Booking Holdings",  ticker: "BKNG",  slug: "bkng",        scores: [m(bkngData),        g(bkngData),        v(bkngData)],        href: "/stocks/bkng",        category: "Platforms",    ...t(bkngData)        },
    ...
    { name: "Nike",              ticker: "NKE",   slug: "nke",         scores: [m(nkeData),         g(nkeData),         v(nkeData)],         href: "/stocks/nke",         category: "Consumer",       ...t(nkeData)         },
    { name: "Lululemon Athletica",ticker: "LULU", slug: "lulu",        scores: [m(luluData),        g(luluData),        v(luluData)],        href: "/stocks/lulu",        category: "Consumer",       ...t(luluData)        },
    { name: "Estée Lauder",      ticker: "EL",    slug: "el",          scores: [m(elData),          g(elData),          v(elData)],          href: "/stocks/el",          category: "Consumer",       ...t(elData)          },
    { name: "Alibaba Group",     ticker: "BABA",  slug: "baba",        scores: [m(babaData),        g(babaData),        v(babaData)],        href: "/stocks/baba",        category: "Platforms",    ...t(babaData)        },
    { name: "PDD Holdings",      ticker: "PDD",   slug: "pdd",         scores: [m(pddData),         g(pddData),         v(pddData)],         href: "/stocks/pdd",         category: "Platforms",       ...t(pddData)         },
    { name: "Baidu",             ticker: "BIDU",  slug: "bidu",        scores: [m(biduData),        g(biduData),        v(biduData)],        href: "/stocks/bidu",        category: "Platforms",    ...t(biduData)        },
    { name: "Snowflake",         ticker: "SNOW",  slug: "snow",        scores: [m(snowData),        g(snowData),        v(snowData)],        href: "/stocks/snow",        category: "Software",    ...t(snowData)        },
    { name: "Datadog",           ticker: "DDOG",  slug: "ddog",        scores: [m(ddogData),        g(ddogData),        v(ddogData)],        href: "/stocks/ddog",        category: "Software",    ...t(ddogData)        },
    { name: "Atlassian",         ticker: "TEAM",  slug: "team",        scores: [m(teamData),        g(teamData),        v(teamData)],        href: "/stocks/team",        category: "Software",    ...t(teamData)        },
    { name: "MongoDB",           ticker: "MDB",   slug: "mdb",         scores: [m(mdbData),         g(mdbData),         v(mdbData)],         href: "/stocks/mdb",         category: "Software",    ...t(mdbData)         },
    { name: "Synopsys",          ticker: "SNPS",  slug: "snps",        scores: [m(snpsData),        g(snpsData),        v(snpsData)],        href: "/stocks/snps",        category: "Semiconductors",    ...t(snpsData)        },
    { name: "Cadence Design Systems", ticker: "CDNS", slug: "cdns",   scores: [m(cdnsData),        g(cdnsData),        v(cdnsData)],        href: "/stocks/cdns",        category: "Semiconductors",    ...t(cdnsData)        },
    { name: "Bloom Energy",      ticker: "BE",    slug: "be",          scores: [m(beData),          g(beData),          v(beData)],          href: "/stocks/be",          category: "Industrials", ...t(beData)          },
    { name: "CoreWeave",         ticker: "CRWV",  slug: "crwv",        scores: [m(crwvData),        g(crwvData),        v(crwvData)],        href: "/stocks/crwv",        category: "Software",    ...t(crwvData)        },
    { name: "Nebius Group",      ticker: "NBIS",  slug: "nbis",        scores: [m(nbisData),        g(nbisData),        v(nbisData)],        href: "/stocks/nbis",        category: "Software",    ...t(nbisData)        },
    ...
    { name: "Qualcomm",          ticker: "QCOM",  slug: "qcom",        scores: [m(qcomData),        g(qcomData),        v(qcomData)],        href: "/stocks/qcom",        category: "Semiconductors",    ...t(qcomData)        },
    ...
    { name: "Amkor Technology",  ticker: "AMKR",  slug: "amkr",        scores: [m(amkrData),        g(amkrData),        v(amkrData)],        href: "/stocks/amkr",        category: "Semiconductors",    ...t(amkrData)        },
    { name: "Zeta Global",       ticker: "ZETA",  slug: "zeta",        scores: [m(zetaData),        g(zetaData),        v(zetaData)],        href: "/stocks/zeta",        category: "Platforms",    ...t(zetaData)        },
    { name: "Samsung Electronics", ticker: "005930.KS", slug: "samsung", scores: [m(samsungData),   g(samsungData),     v(samsungData)],     href: "/stocks/samsung",     category: "Semiconductors",    ...t(samsungData)     },
    ...
    { name: "Teradyne",          ticker: "TER",   slug: "ter",         scores: [m(terData),         g(terData),         v(terData)],         href: "/stocks/ter",         category: "Semiconductors", ...t(terData)         },
    ...
    { name: "IonQ",              ticker: "IONQ",  slug: "ionq",        scores: [m(ionqData),        g(ionqData),        v(ionqData)],        href: "/stocks/ionq",        category: "Semiconductors",    ...t(ionqData)        },
    { name: "D-Wave Quantum",    ticker: "QBTS",  slug: "qbts",        scores: [m(qbtsData),        g(qbtsData),        v(qbtsData)],        href: "/stocks/qbts",        category: "Semiconductors",    ...t(qbtsData)        },
    { name: "Rigetti Computing", ticker: "RGTI",  slug: "rgti",        scores: [m(rgtiData),        g(rgtiData),        v(rgtiData)],        href: "/stocks/rgti",        category: "Semiconductors",    ...t(rgtiData)        },
    { name: "Quantum Computing Inc.", ticker: "QUBT", slug: "qubt",    scores: [m(qubtData),        g(qubtData),        v(qubtData)],        href: "/stocks/qubt",        category: "Semiconductors",    ...t(qubtData)        },
    { name: "Snap Inc.",         ticker: "SNAP",  slug: "snap",        scores: [m(snapData),        g(snapData),        v(snapData)],        href: "/stocks/snap",        category: "Platforms",    ...t(snapData)        },
];
