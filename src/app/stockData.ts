export const stockData = [
    ...
    { name: "ASML", ticker: "ASML", scores: [99, 85, 72], href: "/stocks/asml", category: "Big Tech" },
    { name: "Netflix", ticker: "NFLX", scores: [85, 88, 52], href: "/stocks/nflx", category: "Big Tech" },
    ...
    { name: "Salesforce", ticker: "CRM", scores: [92, 80, 68], href: "/stocks/crm", category: "Financials" },
    { name: "Adobe", ticker: "ADBE", scores: [96, 82, 64], href: "/stocks/adbe", category: "Financials" },
    ...
    { name: "Gold", ticker: "XAU", scores: [88, 50, 55], href: "/stocks/gold", category: "Hard Assets" },
