...
const allCoverageData = [
    ...
    { name: "Constellation Energy", ticker: "CEG", slug: "ceg",      scores: [84, 72, 71], href: "/stocks/ceg",         category: "Other",       bearTarget: "$200",      baseTarget: "$420",      bullTarget: "$650"      },
    { name: "UnitedHealth",      ticker: "UNH",  slug: "unh",         scores: [83, 75, 78], href: "/stocks/unh",         category: "Healthcare",  bearTarget: "$200",      baseTarget: "$380",      bullTarget: "$600"      },
    { name: "Moody's",           ticker: "MCO",  slug: "mco",         scores: [87, 80, 76], href: "/stocks/mco",         category: "Financials",  bearTarget: "$340",      baseTarget: "$560",      bullTarget: "$750"      },
    { name: "Microsoft",         ticker: "MSFT", slug: "msft",        scores: [84, 88, 72], href: "/stocks/msft",        category: "Big Tech",    bearTarget: "$300",      baseTarget: "$450",      bullTarget: "$580"      },
    { name: "Mastercard",        ticker: "MA",   slug: "mastercard",  scores: [88, 88, 78], href: "/stocks/mastercard",  category: "Financials",  bearTarget: "$400",      baseTarget: "$555",      bullTarget: "$700"      },
    ...
    { name: "Amazon",            ticker: "AMZN", slug: "amazon",      scores: [80, 90, 72], href: "/stocks/amazon",      category: "Big Tech",    bearTarget: "$145",      baseTarget: "$225",      bullTarget: "$310"      },
    ...
    { name: "Visa",              ticker: "V",    slug: "visa",        scores: [90, 82, 80], href: "/stocks/visa",        category: "Financials",  bearTarget: "$245",      baseTarget: "$335",      bullTarget: "$420"      },
