...
const FAQS = [
  ...
  {
    q: "Why no gold?",
    a: "Gold is fully analyzed and scores a composite of 73 — respectable, but 70th in the universe and short of the 80-point inclusion threshold. Commodities are scored on three pillars — absolute scarcity, monetary history, industrial utility — with the declared primary pillar carrying 40%, so gold scores on its monetary history rather than being dragged down by thin industrial demand. Its moat comes out at 70. What keeps it out is growth of 71: gold produces no earnings, revenue, or cash flow and cannot compound. Bitcoin carries the same hard-money and inflation-hedge thesis with network effects and digital divisibility, and scores 81 — but the two now score identically on growth at 71, because Bitcoin's adoption CAGR was re-anchored in July 2026 to the rates its holder and address series actually show rather than an assumed long-run number. Bitcoin's remaining edge over gold is its moat, 94 against 70, and a slightly better entry on valuation. Gold stays in the coverage universe and earns a position the moment its composite clears the threshold and outranks the weakest holding.",
  },
  {
