            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  "Saturates: 100 pts / 20 pts at the extremes",
      ...
      <section className="animate-fade-up stagger-fill-both pb-20 md:pb-24" style={{ animationDelay: '0.35s' }}>
        <div className="mb-6">
          ...
          <p className="text-white/40 text-sm leading-relaxed max-w-3xl">
            ...
            <span className="text-white/60 font-medium">strong (100) · intact (65) · weakened (35) · destroyed (10)</span>.
        ...
        <div className="rounded-xl border border-white/[0.04] bg-white/[0.015] p-5 mt-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <p className="text-white/30 text-xs leading-relaxed">
              Each moat is rated{" "}
              <span className="text-white/50 font-medium">strong (100) · intact (65) · weakened (35) · destroyed (10)</span>.
