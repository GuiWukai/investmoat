...
export default function MastercardPage() {
  const overallScore = getAverageScore(stockData.find(s => s.ticker === 'MA')!.scores);
  return (
    <div className="animate-fade-in pb-12">
      ...
      <ScoreTabsRow overallScore={overallScore} tabs={[
        ...
        {
          label: "Growth",
          gauge: (<ScoreGauge score={88} label="Growth Score" description="Faster growth than Visa in service revenue and data analytics." />),
          detail: (
            <div className="space-y-4">
              <MetricCard
          title="GDV Growth"
        ...
        {
          label: "Value",
          gauge: (<ScoreGauge score={70} label="Valuation Score" description="Trades at a premium (32x P/E) but justified by higher growth profile." />),
          detail: (
            <div className="space-y-4">
              <ScenarioCard
            type="Bear"
