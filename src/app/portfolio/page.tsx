...
const stockMeta: Record<string, { color: string; category: string; exclusionReason?: string }> = {
  ...
  KNT:   { color: "#8b7355", category: "Hard Assets",     exclusionReason: "Composite (74) falls below the portfolio threshold. The moat score (62) is typical for a single-asset miner — strong PNG regulatory lock-in and a high-grade orebody, offset by selling a fungible, price-taking commodity to switchable smelters with no pricing power or network effects. High growth (83) reflects Stage 3/4 production-expansion upside, not the scalable, capital-light compounding this portfolio targets." },
